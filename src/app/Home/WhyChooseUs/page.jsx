           ...
           <p className="text-gray-600 text-xl text-center mb-12">We're committed to delivering exceptional service that exceeds your expectations. Our team of experts is dedicated to ensuring your satisfaction and providing solutions that meet your needs.</p>
            ...
            <div className="flex flex-row flex-wrap justify-center gap-8 max-w-7xl mx-auto">
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    ...
                    <FaUser className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
                ...
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <FaClock className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
                ...
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <FaHeadphones className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
                ...
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <FaTools className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
                ...
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <FaUserShield className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
                ...
                <div className="group relative bg-white/90 backdrop-blur-lg px-8 py-12 rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-indigo-800 hover:to-purple-800 hover:text-white w-72 transform hover:-translate-y-3 border border-gray-200/50 hover:border-indigo-500/50 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <GoPackage className="relative h-14 w-14 text-indigo-600 mb-6 group-hover:text-white transition-all duration-500 mx-auto group-hover:scale-105" />
