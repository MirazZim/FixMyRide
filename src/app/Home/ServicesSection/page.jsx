...
export default async function ServicesSection() {
  ...
  return (
    <div className='grid grid-cols-12'>
        {data.map(service => (
            <div key={service._id} className='col-span-4 p-4 bg-white shadow-lg rounded-lg'>
                <Image width={314} height={150} src={service.img} alt={service.title} className='object-cover' />
